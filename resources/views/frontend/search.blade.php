...
@section('content')
    <head>
        ...
        <title>更新列表</title>
        <meta name="keywords" content="搜索小说" />
        <meta name="description" content="搜索小说" />
    ...
    <div id="wrapper">
        <div class="header">
            ...
            <div class="header_search">
                <form name="articlesearch" method="post" action="{{url('/search')}}">
                    {{csrf_field()}}
                    <input type="text" name="searchkey" class="search"  id="search_keyword" placeholder="请输入小说名" value="{{$searchKey}}"/>
